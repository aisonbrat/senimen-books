...
export default function EditorDashboardProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--bg-page)]">
      <SiteHeader badge="Редактор" userLabel={userLabel} onLogout={handleLogout} />

      <main className="mx-auto max-w-3xl px-5 pb-24 pt-12 md:px-8 md:pt-16">
