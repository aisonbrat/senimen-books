...
export const ORDERS_EDITOR_SELECT = [
  ...
  'answer_font_preset',
  'answer_text_align',
  'cover_title_font_preset',
  'editor_skipped_chapter_ids',
  'algy_font_preset',
  'hat_font_preset',
...
/** Same as `ORDERS_EDITOR_SELECT` before book-settings columns (unmigrated DB fallback). */
export const ORDERS_EDITOR_SELECT_LEGACY = [
  'id',
  'client_id',
  'category_id',
  'author_name',
